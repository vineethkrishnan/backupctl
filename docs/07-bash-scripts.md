...
── Projects ─────────────────────────────────
  ...
  Restic repository path [/backups/vinelab]: /backups/vinelab
...
backupctl-dev config show vinelab
```
...
backupctl  | [2026-03-18 00:00:01] [info] Registered cron: vinelab (0 0 * * *)
...
/app # ls /data/backups/vinelab/
vinelab_db_20260318_000032.sql.gz.gpg
uploads/
assets/
...
Next scheduled:
  vinelab     2026-03-19 00:00:00 (in 23h 58m)
